...
# --- Configuration ---
TOKEN = os.getenv('TELEGRAM_BOT_TOKEN', '8159101481:AAEd_2NPjFCxDoG348M-Lk6KdJH3epz4ShM')
OWNER_ID = int(os.getenv('OWNER_ID', '5619786279'))
ADMIN_ID = int(os.getenv('ADMIN_ID', '5619786279'))
YOUR_USERNAME = os.getenv('BOT_USERNAME', '@Darkeyy7')
UPDATE_CHANNEL = os.getenv('UPDATE_CHANNEL', 'https://t.me/Dark_Legacy79')
